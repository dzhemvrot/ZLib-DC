...
class Window:
    ...
    def __init__(self, master):
        ...
        self.L1 = Label(self.Main, text = "zlib DC - zlib (De-)Compresser v3.4")
    ...
    def About(self):
        tk.messagebox.showinfo(title='About', message='''This is a program to compress and decompress files, using zlib.
